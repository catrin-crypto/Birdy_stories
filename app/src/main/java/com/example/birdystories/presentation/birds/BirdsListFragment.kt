...
class BirdsListFragment : AbsFragment(fragment_birds_list), BirdsView, BirdsListRvAdapter.Delegate {
    ...
    @Inject
    lateinit var presenterFactory: BirdsListPresenterAssistedFactory
